...
public:
	...
	void ResetAnterior() { m_DijkstraAnterior = NULL; };
...
public:
	...
	void ClearDistances();
	void ResetColor();
	void ResetAnteriors(){for(CVertex v : m_Vertices){v.ResetAnterior();}}
	// Vertices
...
public:
	...
	bool Empty(){ return m_Vertices.empty(); }
};
...
void RecursiveHull(list<CVertex*>, list<CVertex*> ll, CGPoint esq, CGPoint drt);
